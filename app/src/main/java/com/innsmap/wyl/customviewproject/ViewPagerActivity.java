...
import com.innsmap.wyl.customview.ViewPagerTitle;
import com.innsmap.wyl.customviewproject.adapter.MyPagerAdapter;
...
public class ViewPagerActivity extends AppCompatActivity {
    ...
    private View view7;
    private View view8;
private String string[] = {"关注", "推荐", "视频", "直播", "图片", "段子", "精华", "热门"};
    @Override
